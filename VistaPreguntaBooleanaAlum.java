...
public class VistaPreguntaBooleanaAlum extends JPanel{

	private static final long serialVersionUID = 1L;
	private JLabel etiquetaEnunciado, etiquetaPuntuacion;
	private JButton botonEnviarRespuesta;
	
	public VistaPreguntaBooleanaAlum(PreguntaBooleana pregunta){
		...
		botonEnviarRespuesta.setPreferredSize(new Dimension(150,75));
		this.add(botonEnviarRespuesta);
		
		layout.putConstraint(SpringLayout.SOUTH, botonEnviarRespuesta, -5, SpringLayout.SOUTH, this);
		layout.putConstraint(SpringLayout.HORIZONTAL_CENTER, botonEnviarRespuesta, 0, SpringLayout.HORIZONTAL_CENTER, this);
