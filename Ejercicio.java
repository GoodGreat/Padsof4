...
public class Ejercicio implements Serializable{
	...
	/**
	 *  Indica si un ejercicio esta dentro de plazo o no 
	 *  
	 *  @return booleano a true si esta en plazo y false en caso contrario
	 */
	public boolean estaEnPlazo() {
		Calendar ahoramismo = Calendar.getInstance();
		if(ahoramismo.after(this.fechaIni) && ahoramismo.before(this.fechaFin)){
			return true;
		}
			return false;
	}
	...
	public boolean registrarRespuestaAlumno(Alumno alumno, Pregunta pregunta, List<Opcion> opciones){
		...
		if (Sistema.getInstance().isProf() == false && this.estaEnPlazo() == true && this.visible == true) {
