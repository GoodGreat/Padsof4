...
public class VistaCambiarPregunta extends JPanel{
	...
	private JButton botonGuardarCambios, botonAniadirOpcion, botonAniadirSolucion;
	
	/**
	 * Constructor del panel de Crear Asignatura
	 * @author Alvaro Martinez de Navascues
	 */
	public VistaCambiarPregunta(){
		...
		//Constraints
		layoutPrincipal.putConstraint(SpringLayout.HORIZONTAL_CENTER, botonAniadirSolucion, 75, SpringLayout.HORIZONTAL_CENTER, this);
		layoutPrincipal.putConstraint(SpringLayout.SOUTH, botonAniadirSolucion, -75, SpringLayout.SOUTH, this);
		
		
		
		
		botonGuardarCambios = new JButton("Aniadir Pregunta");
		botonGuardarCambios.setPreferredSize(new Dimension(150,70));
		...
		layoutPrincipal.putConstraint(SpringLayout.SOUTH, botonGuardarCambios, -10, SpringLayout.SOUTH, this);
