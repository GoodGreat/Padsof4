...
public class VistaCrearTema extends JPanel{
	...
	public VistaCrearTema(){
		...
		titulo = new JLabel("CREANDO TEMA");
		...
		etiquetaNombre = new JLabel("Nombre del Tema: ");
		...
		this.add(botonCrearTema);
		
		//Constraints
		layoutPrincipal.putConstraint(SpringLayout.HORIZONTAL_CENTER, botonCrearTema, 0, SpringLayout.HORIZONTAL_CENTER, this);
		layoutPrincipal.putConstraint(SpringLayout.SOUTH, botonCrearTema, -30, SpringLayout.SOUTH, this);
