...
/**
 * Clase PreguntaLibre, que implementa las preguntas en las que a los alumnos
 *  no se les presentan opciones entre las que elegir la correcta, 
 *  si no que los mismos alumnos tienen que introducir por teclado su opcion.
 *  
 * @author Alejandro Martin Climent y Alvaro Martinez de Navascues
 *
 */

public class PreguntaLibre extends Pregunta{
	 ...
	 */
	public PreguntaLibre(String enunciado, float puntuacion, boolean falloResta, float resta, String tipo){
	...
	/**
	 *  Getter del Ejercicio al que pertenece una pregunta de tipo Libre
	 *  
	...
	/**
	 *  Setter del Ejercicio al que pertenece una pregunta de tipo Libre
	 *  
	 ...
	 */
	public void setRespuestaProf(RespuestaLibre respuesta){
		Sistema sistema = Sistema.getInstance();
		if(sistema.isProf() == true){
	...
	/**
	 *  Funcion que aniade una respuesta a una pregunta de tipo Libre
	 *  @param alumno. Alumno que va a aniadir la respuesta
	...
	public boolean pregAniadirRespuesta(Alumno alumno, List<Opcion> opciones){			
		...
		RespuestaLibre respuesta = new RespuestaLibre(alumno);
	 ...
	 *  de alumnos que contestaron a una pregunta de tipo Libre
	 *  
	...
	/**
	 *  Funcion que llama a la de la clase superior para calcular el porcentaje
	 *  de alumnos que contestaron bien una pregunta de tipo Libre
	 * 
